...
Notar p = 0456 \> 0.05 (nivel de significancia del 5% con un umbral de confianza del 95% ) es decir, p -grande \^ X² = 8.69 pequeño entonces para los dígitos de la unidad del número de dos dígitos **se cumple** que los datos son compatibles con el modelo de uniformidad , cada número tiene un peso equiprobable de ocurrencia.
